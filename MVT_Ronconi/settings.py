"""
Django settings for MVT_Ronconi project.
...
SECRET_KEY = 'django-insecure-2xa9%*bk#5+-3$td$w&(5(f#y+#71%@9-w5z%di@x(6m&b&=x^'
...
WSGI_APPLICATION = 'MVT_Ronconi.wsgi.application'
